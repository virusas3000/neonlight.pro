...
<div class="nl-page nl-shop-page">
	<div class="nl-shop-header">
		<nav class="nl-breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>"><?php echo nl_t('shop_breadcrumb_home'); ?></a> / <span><?php echo nl_t('balloon_title'); ?></span></nav>
		<h1 class="nl-shop-title"><?php echo nl_t('balloon_title'); ?></h1>
	...
	<?php else : ?>
		<div style="text-align:center; padding:60px 20px;">
			<p><?php echo nl_t('balloon_coming'); ?></p>
		</div>
	<?php endif; ?>
</div>

<style>
/* Balloon & Magic shop page */

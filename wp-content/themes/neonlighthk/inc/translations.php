...
function nl_dictionary() {
    return [
        ...
        'nav_projects'  => ['en'=>'PROJECTS',   'zh'=>'過往項目',   'cn'=>'过往项目'],
        'nav_projects_bi'=>['en'=>'PROJECTS',   'zh'=>'過往項目·PROJECTS','cn'=>'过往项目·PROJECTS'],
        ...
        'ws_apply_title'=> ['en'=>'Group workshop enquiry', 'zh'=>'團體工作坊查詢', 'cn'=>'团体工作坊查询'],
        ...
        'neon_apply_title'    => ['en'=>'Neonlight Enquiry',      'zh'=>'霓虹燈查詢',       'cn'=>'霓虹灯查询'],
        'neon_message'        => ['en'=>'Message',                'zh'=>'內容',             'cn'=>'内容'],
        ...
        'product_details_desc' => ['en'=>'Description', 'zh'=>'產品描述', 'cn'=>'产品描述'],
        'product_details_specs'=> ['en'=>'Specifications', 'zh'=>'產品規格', 'cn'=>'产品规格'],
        'product_details_info' => ['en'=>'Product Information', 'zh'=>'產品資訊', 'cn'=>'产品资讯'],
        'product_sku'          => ['en'=>'SKU', 'zh'=>'產品編號', 'cn'=>'产品编号'],
        'product_dimensions'   => ['en'=>'Dimensions', 'zh'=>'尺寸', 'cn'=>'尺寸'],
        'product_weight'       => ['en'=>'Weight', 'zh'=>'重量', 'cn'=>'重量'],

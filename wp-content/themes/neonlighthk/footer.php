...
<div class="nl-footer__inner">
	...
	<nav class="nl-footer__nav" aria-label="Footer">
		<ul id="menu-footer-menu" class="menu">
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>?page_id=96&lang=<?php echo nl_lang(); ?>"><?php echo nl_t('nav_about_lookbook'); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>?page_id=45&lang=<?php echo nl_lang(); ?>"><?php echo nl_t('nav_workshop'); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>?page_id=95&lang=<?php echo nl_lang(); ?>"><?php echo nl_t('nav_neon'); ?></a></li>
			...
			<li><a href="<?php
				if ( function_exists('wc_get_page_permalink') ) {
					...
					?>?page_id=4&lang=<?php echo nl_lang();
				}
			?>"><?php echo nl_t('nav_products'); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>?page_id=14&lang=<?php echo nl_lang(); ?>"><?php echo nl_t('nav_balloon'); ?></a></li>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>?page_id=138&lang=<?php echo nl_lang(); ?>"><?php echo nl_t('nav_hanfu'); ?></a></li>
		</ul>
	</nav>
